...
public class LocationSongPlaying {
	...
	public static Song getCurrentlyPlayingSong(Location location) {
		...
		LocationMusicItem locationMusicItemCurrentlyPlaying = location.getLocationMusicItem(currentlyPlayingLocationMusicItemIndex);
		...
		if (locationMusicItemCurrentlyPlaying instanceof Song) {
			...
			int currentlyPlayingWithinLocationMusicItemIndex = withinLocationMusicItemCurrentlyPlayingIndexMap.get(location);
			Song song = ((Playlist) locationMusicItemCurrentlyPlaying).getSong(currentlyPlayingWithinLocationMusicItemIndex);
			return song;
		}
